	...
	function (codes, code) {
		if (_elm_lang$core$String$isEmpty(code)) {
			...
			var _p0 = A2(
				...
				_elm_lang$core$String$toUpper(code),
				codes);
			if (_p0.ctor === 'Just') {
				return _p0._0;
			} else {
		...
		if (_p1.ctor === 'LoadedCodes') {
			if (_p1._0.ctor === 'Ok') {
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						codes: _elm_lang$core$Dict$empty,
						codesLoadError: _elm_lang$core$Maybe$Just(
							A2(_elm_lang$core$Debug$log, 'err', _p1._0._0))
					});
			}
		} else {
			var _p2 = _p1._0;
			return _elm_lang$core$Native_Utils.update(
				...
				{
					code: _p2,
					result: A2(_user$project$Main$lookupCode, model.codes, _p2)
				});
		}
	});
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {code: a, result: b, codes: c, codesLoadError: d};
	});
...
var _user$project$Main$loadCodes = function (url) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$LoadedCodes,
		A2(
	...
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			...
			codes: _elm_lang$core$Dict$fromList(
				{ctor: '[]'}),
			codesLoadError: _elm_lang$core$Maybe$Nothing
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Region code'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$Change),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(model.code),
											_1: {ctor: '[]'}
										}
									}
								},
